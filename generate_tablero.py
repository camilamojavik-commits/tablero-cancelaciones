#!/usr/bin/env python3
"""
Tablero de Cancelaciones Ã¢ÂÂ Coderhouse
...
def build_dataset():
    ...
    filtered = [i for i in all_incidents if i.get("type") in ("INSTRUCTOR_ABSENCE", "CLASS_ISSUES") and "fecha de inicio" not in (i.get("summary") or "").lower() and "fecha de inicio" not in (i.get("description") or "").lower()]
    ...
    for inc in filtered:
        ...
        records.append({
            "id": inc["id"],
            "date": to_argentina_date(inc.get("createdAt", "")),  # UTCÃ¢ÂÂARG (UTC-3)
            "type": inc["type"],
            "status": inc["status"],
    ...
    if all_active_raw:
        # Use full universe Ã¢ÂÂ correct denominator
...
<title>Tablero de Cancelaciones Ã¢ÂÂ Coderhouse</title>
...
<div id="login-overlay">
  ...
  <input type="password" id="pwd-input" placeholder="ContraseÃÂ±a" onkeydown="if(event.key==='Enter')checkPwd()" />
...
<div id="app" style="display:none">
  ...
  <div class="main">
    <div class="kpi-grid">
      <div class="kpi-card">
        ...
        <div class="kpi-value" id="kpi-total">Ã¢ÂÂ</div>
        <div class="kpi-sub">incidents en el perÃÂ­odo</div>
      </div>
      <div class="kpi-card kpi-rate-card">
        <div class="kpi-label">Tasa de cancelaciÃÂ³n</div>
        <div class="kpi-value" id="kpi-rate">Ã¢ÂÂ</div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value" id="kpi-commissions">Ã¢ÂÂ</div>
        <div class="kpi-sub">comisiones ÃÂºnicas</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">DÃÂ­as con incidents</div>
        <div class="kpi-value" id="kpi-days">Ã¢ÂÂ</div>
        <div class="kpi-sub">dÃÂ­as distintos</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">Top curso afectado</div>
        <div class="kpi-value" id="kpi-top-count">Ã¢ÂÂ</div>
        <div class="kpi-sub" id="kpi-top-name">Ã¢ÂÂ</div>
      </div>
    </div>
    ...
    <div class="type-row">
      <div class="type-card">
        ...
        <div>
          ...
          <div class="type-count" id="type-absence-count">Ã¢ÂÂ</div>
          <div class="type-pct" id="type-absence-pct">Ã¢ÂÂ</div>
        </div>
      </div>
      <div class="type-card">
        ...
        <div>
          ...
          <div class="type-count" id="type-issues-count">Ã¢ÂÂ</div>
          <div class="type-pct" id="type-issues-pct">Ã¢ÂÂ</div>
        </div>
      </div>
    </div>
    ...
    <div class="charts-row">
      <div class="chart-card">
        <h2>Incidents por dÃÂ­a</h2>
        <div class="timeline-bars" id="timeline-bars"></div>
      </div>
      <div class="chart-card">
        <h2>Top comisiones ÃÂ· cancelaciones / clases</h2>
    ...
    <div class="table-section">
      <div class="table-header">
        ...
        <div class="table-controls">
          <input type="text" class="search-input" id="search-input" placeholder="Buscar curso, comisiÃÂ³n..." oninput="renderTable()" />
      ...
      <div style="overflow-x:auto">
        <table>
          <thead><tr><th>Fecha</th><th>Curso</th><th>ComisiÃÂ³n</th><th>Tipo</th><th>Estado</th><th>DescripciÃÂ³n</th></tr></thead>
  ...
  <div class="footer">
    ...
    <div class="footer-date">Actualizado el {today} ÃÂ· GitHub Actions</div>
  </div>
</div>
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ AUTH Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
async function checkPwd() {{
  ...
  if (hash === PWD_HASH) {{
    ...
    document.getElementById("login-error").textContent = "ContraseÃÂ±a incorrecta";
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ CLASS COUNT (cruce con cohortes activas) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ FILTERS Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function getRange() {{
...
function updateAll() {{
  const from = document.getElementById("date-from").value;
  const to   = document.getElementById("date-to").value;
  const fmt = d => d ? d.split("-").reverse().join("/") : "Ã¢ÂÂ";
  document.getElementById("period-label").textContent = `${{fmt(from)}} Ã¢ÂÂ ${{fmt(to)}}`;
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ KPIs Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function renderKPIs() {{
  const from  = document.getElementById("date-from").value;
  const to    = document.getElementById("date-to").value;
  ...
  if (top) {{
    ...
    document.getElementById("kpi-top-name").textContent  = top[0].length > 28 ? top[0].slice(0,26)+"Ã¢ÂÂ¦" : top[0];
  }}

  // Tasa de cancelaciÃÂ³n vs clases dictadas
  ...
  if (totalClasses && total > 0) {{
    ...
    document.getElementById("kpi-rate-detail").textContent = "Sin clases en el perÃÂ­odo";
  }} else {{
    document.getElementById("kpi-rate").textContent        = "Ã¢ÂÂ";
    document.getElementById("kpi-rate-sub").textContent    = "sin datos de horario";
    document.getElementById("kpi-rate-detail").textContent = "";
  }}
}}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ TYPE BREAKDOWN Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ TIMELINE Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function renderTimeline() {{
    ...
    allDays.forEach(date => {{
      ...
      bar.addEventListener("mouseenter", e => {{
        ...
        let html = `<strong>${{date.split("-").reverse().join("/")}} Ã¢ÂÂ ${{items.length}} incident${{items.length!==1?"s":""}}</strong>`;
        if (classCount) {{
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ RANKING Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function renderRanking() {{
  ...
  container.innerHTML = sorted.map(([key, count]) => {{
    ...
    const short           = course.length > 28 ? course.slice(0,26)+"Ã¢ÂÂ¦" : course;
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ TABLE Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function renderTable() {{
  ...
  document.getElementById("table-body").innerHTML = rows.map(r => {{
    ...
    return `<tr class="${{isA?"row-absence":"row-issues"}}">
      ...
      <td><strong style="font-size:12px">${{r.cohortName||"Ã¢ÂÂ"}}</strong></td>
      <td style="font-weight:600">#${{r.commissionNumber||"Ã¢ÂÂ"}}</td>
      <td><span class="badge ${{isA?"badge-absence":"badge-issues"}}">${{isA?"AUSENCIA":"CLASS ISSUE"}}</span></td>
      <td>${{sBadge(r.status)}}</td>
      <td style="color:#555;font-size:12px;max-width:200px">${{(r.description||r.summary||"Ã¢ÂÂ").slice(0,80)}}</td>
    </tr>`;
  }}).join("") || "<tr><td colspan='6' style='text-align:center;padding:40px;color:#BBBBBB'>Sin resultados</td></tr>";
}}

// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ INIT Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
function init() {{
  const r = getRange();
  document.getElementById("date-from").value = r.min;
  document.getElementById("date-to").value   = r.max;
...
if __name__ == "__main__":
    ...
    with open("output/index.html", "w", encoding="utf-8") as f:
        f.write(html)
    print(f"Ã¢ÂÂ index.html generado con {len(records)} incidents y {len(cohort_schedule)} cohortes activas")
    if records:
        dates = sorted(r["date"] for r in records)
        print(f"Ã°ÂÂÂ Rango incidents: {dates[0]} Ã¢ÂÂ {dates[-1]}")
        top3 = Counter(r["cohortName"] for r in records).most_common(3)
        print("Ã°ÂÂÂ Top 3 cursos:")
